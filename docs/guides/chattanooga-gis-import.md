...
| Riverwalk, Zoo, Cherokee, Moccasin Bend, and South Chickamauga route files | Normalize as route geometry when a `routes` collection is added. The current `BikeRoute` content still lives in TypeScript/Mapbox Studio. |
