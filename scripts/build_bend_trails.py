...
elevation port in osm_trail_elevation.py), and emit:
  ...
  - public/data/elevation/bend/<slug>.json       — per-trail profile for the pane
...
from _geo import M_TO_FT, M_TO_MI, esc, slugify
...
def write_data_ts(trails: list[dict]) -> None:
    lines = [
        ...
        "import { trailColor } from '@/data/trail-metadata';",
        "",
